...
L['Spacing'] = '간격'
L['Tweak the space between bars'] = '바간에 간격을 조절합니다'
L['Change size'] = '크기 변경'
...
L['Texts'] = '글자'
L['Bar Text'] = '바 글자'
L['Set the bar text'] = '바 글자를 설정합니다'
...
L['Text Color'] = '글자 색상'
L['Set the color of the text for the bars'] = '바를 위한 글자의 색상을 설정합니다'
L['Font'] = '글꼴'
L['Set the font used in the bars'] = '바에서 사용할 글꼴을 설정합니다'
L['Font Size'] = '글꼴 크기'
L['Text Color'] = '문자 색상'
L['Set the color of the text for the bars'] = '바를 위한 글자의 색상을 설정합니다'
L['Font'] = '글꼴'
...
L['Buff Color'] = '버프 색상'
L['Set the color of the bars for buffs'] = '버프를 위한 바의 색상을 설정합니다'
L['Background Color'] = '배경 색상'
L['Set the color of the bars background'] = '바 배경 색상을 설정합니다'
L['Debuff Colors'] = '디버프 색상'
L['Set the color of the bars for debuffs'] = '디버프를 위한 바의 색상을 설정합니다'
L['Set color for normal'] = '일반 디버프를 위한 색상을 설정합니다'
L['Different colors'] = '서로 다른 색상'
L['Different colors for different debuffs types'] = '서로 다른 디버프의 유형에 대해 서로 다른 색상을 설정합니다'
L['Set color for curses'] = '저주 디버프를 위한 색상을 설정합니다'
L['Set color for poisons'] = '독 디버프를 위한 색상을 설정합니다'
L['Set color for magics'] = '마법 디버프를 위한 색상을 설정합니다'
L['Set color for diseases'] = '질병 디버프를 위한 색상을 설정합니다'
L['Misc'] = '기타'
